...
||��✒ Lurkset       - Set Point Read
||��✒ Lurkon        - Reading Point
||��✒ Ginfo         - Info Grup
||===== F O R   A D M I N =====||
...
Http://line.me/ti/p/~my.name.is.jalu
                     ...
                     ATTENTION!!!!
 🔞   Support by 🔯 Squad Jago 🔯   🔞
"""
helo=""

KAC=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,k1,k2,k3,k4,k5,k6,k7,w1,w2,w3,w4,w5,w6,w7,l1,l2,l3,l4,l5]
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,k1mid,k2mid,k3mid,k4mid,k5mid,k6mid,k7mid,w1mid,w2mid,w3mid,w4mid,w5mid,w6mid,w7mid,l1mid,l2mid,l3mid,l4mid,l5mid,"uaed33f60ed0b0d5ee5b33cc5c979d770"]
admsa = "uaed33f60ed0b0d5ee5b33cc5c979d770","u777a5944f2b99b7e209cc264a953c091"
admin = "uaed33f60ed0b0d5ee5b33cc5c979d770","u777a5944f2b99b7e209cc264a953c091"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"thanks for add 😘😘 Creator : Http://line.me/ti/p/~my.name.is.jalu",
    "lang":"JP",
    "comment":"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nCreator : Http://line.me/ti/p/~my.name.is.jalu",
    "commentOn":False,
    "likeOn":False,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uaed33f60ed0b0d5ee5b33cc5c979d770","u777a5944f2b99b7e209cc264a953c091":
                    if "join:" in msg.text:
                         ...
                         if targets == []:
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     random.choice(KAC).sendText(msg.to,"Invited this Squad Jago 🔞: \n➡" + _name)
...
#--------------------------------------------------------
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Siap On bos 🔞")
                    else:
                ...
                if wait["inviteprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Siap On bos 🔞􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"Sudah On bos 🔞")
                ...
                if wait["autoJoin"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah On bos 🔞")
            elif msg.text in ["Mode:on","Panick:on"]:
              if msg.from_ in admin:
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Siap On bos 🔞")
                ...
                if wait["linkprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Siap On bos 🔞")
            elif msg.text in ["Mode:off","Panick:off"]:
              if msg.from_ in admin:
            ...
            elif msg.text == "Lurkset":
                if msg.toType == 2:
                    cl.sendText(msg.to, "Squad Jago was here 🔞" + datetime.now().strftime('\n%Y/%m/%d %H:%M:%S'))
                    try:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n [☸]➦Powered By: ┅─────┅Squad Jago┅─────┅" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------ADMIN COMMAND------------------------------#
                             ...
                             if not target in Bots:
                                if not target in admin:
                                  try:
                                      ...
                                      cl.sendText(msg.to,"Squad Jago was here 🔞")
              ...
              if msg.from_ in admin:
                ...
                start = time.time()
                cl.sendText(msg.to, "Mohon Bersabar Botnya sedang Anu 🔞...")
...
#-----------------------------------------------------------
                ...
                start = time.time()
                ki.sendText(msg.to, "Mohon Bersabar Karna bot nya masih ngopi 😘...")
                elapsed_time = time.time() - start
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to, "Hadir kk")
                profile = ki2.getProfile()
                text = profile.displayName
                ki2.sendText(msg.to, "Nyimak kk")
                profile = ki3.getProfile()
                text = profile.displayName
                ki3.sendText(msg.to, " Yuhuu")
                profile = ki4.getProfile()
                text = profile.displayName
                ki4.sendText(msg.to, "Ada kk jangan kick aim ya")
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                klist=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,w1,w2,w3,w4,w5]
                                kicker=random.choice(klist)
                                kicker.kickoutFromGroup(msg.to,[target])
                                print (msg.to,[g.mid])
                            except:
...
#-----------------------------------------------
            elif msg.text in ["Sayang","Kuy","Pasukan","Beibeh"]:
                if msg.from_ in admsa:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
...
#-----------------------------------------------
                        ...
                        w2.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["Bye","Dadah","Muleh","Pulang"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.sendText(msg.to,"Bye Bye sayang 😘 "  +  str(ginfo.name)  + "")
...
#            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nHttp://line.me/ti/p/~my.name.is.jalu")
#            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nHttp://line.me/ti/p/~my.name.is.jalu")
#            ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nHttp://line.me/ti/p/~my.name.is.jalu")
#            ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nHttp://line.me/ti/p/~my.name.is.jalu")
#            ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nHttp://line.me/ti/p/~my.name.is.jalu")
#            ki6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔞 ֆզυαδ յαցο ωαֆ իεяε բοя հւκε чουя ֆτατυֆ 🔞\n\nHttp://line.me/ti/p/~my.name.is.jalu")
#            print "Like"
#            print "Like"
#            print "Like"
#          except:
